...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'vw0uvu-vf.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = 'a162c9e232a9c0ce7a56b76f8f10869a';
...
export async function storefrontApiRequest(query: string, variables: Record<string, unknown> = {}) {
  ...
  if (response.status === 402) {
    toast.error("Shopify: Pagamento richiesto", {
      description: "Il tuo store Shopify necessita di un piano a pagamento attivo.",
    });
    return;
  }
