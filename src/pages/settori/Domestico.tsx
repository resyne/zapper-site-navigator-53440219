...
const Domestico = () => {
  ...
  const modelliConsigliati = [
    { 
      name: "ZAPPER S", 
      descrizione: "Perfetto per camini e stufe domestiche",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        {/* Hero Section */}
        <section className="pt-24 pb-12 md:pt-32 md:pb-16 bg-zapper-blue-light">
        ...
        {/* CTA */}
        <section className="py-16 md:py-24 bg-zapper-blue-light">
          <div className="container text-center">
            <h2 className="font-display text-2xl md:text-3xl font-bold text-primary-foreground mb-4">
              Problemi di fumi in casa?
            </h2>
            <p className="text-primary-foreground/80 text-lg mb-8 max-w-2xl mx-auto">
              Richiedi un sopralluogo gratuito. Analizziamo il tuo impianto domestico e ti proponiamo la soluzione più adatta.
            </p>
