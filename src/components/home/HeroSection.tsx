      ...
      <div className="container relative z-10 pt-24 pb-16 md:pt-32 md:pb-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full mb-6 animate-fade-in">
            ...
            <p className="text-lg md:text-xl text-white/80 mb-8 max-w-xl mx-auto lg:mx-0 animate-fade-in-up animation-delay-100">
            ...
            <p className="text-sm text-white/60 mt-3 animate-fade-in-up animation-delay-300">
              Analizziamo il tuo impianto da remoto e definiamo la soluzione ZAPPER più adatta.
            </p>

            {/* Trust Badge */}
            <div className="mt-10 pt-8 border-t border-white/10 animate-fade-in animation-delay-400">
              <div className="flex items-center gap-6 justify-center lg:justify-start">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="w-10 h-10 rounded-full bg-white/20 border-2 border-zapper-black flex items-center justify-center text-xs font-bold text-white"
                    >
          ...
          <div className="relative animate-fade-in-up animation-delay-200">
            <div className="relative">
              ...
              />
              {/* Floating Badge */}
              <div className="absolute -bottom-4 -left-4 md:-bottom-6 md:-left-6 bg-white p-4 md:p-6 rounded-xl shadow-xl animate-float">
