          ...
          <div className="flex items-center justify-center gap-4 mb-10">
            {["sector", "application", "result"].map((step, index) => (
              <div key={step} className="flex items-center gap-4">
                ...
                {index < 2 && (
                  <div className={`w-12 md:w-20 h-1 rounded ${
                    (step === "sector" && currentStep !== "sector") ||
                    (step === "application" && currentStep === "result")
                      ? "bg-primary"
                      : "bg-muted"
                ...
                <div className="grid sm:grid-cols-3 gap-4">
                  {sectors.map((sector) => (
                    ...
                    >
                      ...
                      <h4 className="font-display font-bold text-lg mb-1">{sector.label}</h4>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {applicationsBySection[selectedSector]?.map((app) => (
                    <button
                      ...
                      className="group p-5 rounded-xl border-2 border-border bg-background hover:border-primary hover:bg-primary/5 transition-all duration-200 text-left"
                    >
                      <h4 className="font-display font-bold text-lg mb-1">{app.label}</h4>
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-8">
                  {getRecommendedModels().map((model, index) => (
                    ...
                    >
                      ...
                      <h4 className="font-display text-2xl font-bold mb-2">{model}</h4>
